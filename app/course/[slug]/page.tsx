...
import WatercolorCarousel from "@/components/WatercolorCarousel";
...
export default async function Page({ params }: PageProps) {
  ...
  if (course.slug !== "clay") {
    scheduleQuery =
      scheduleQuery.gte("class_date", today);
  }

  const {
    data: schedules,
    error: scheduleError,
  } = await scheduleQuery.order("class_date", {
    ascending: true,
  });
          ...
          <div className="grid items-start gap-16 lg:grid-cols-2">
            ...
            <div className="lg:sticky lg:top-28">
              ...
              {course.slug === "watercolor" ? (
                ...
                <div className="overflow-hidden rounded-[32px] bg-white p-4 shadow-2xl">
                  <WatercolorCarousel />
                </div>
